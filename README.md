...
验证环境：Node.js 24.19.0、pnpm 11.19.0。开发建议使用 Node.js 24，使用附带的 pnpm-lock.yaml 固定依赖；Release 试玩包只需 Node.js 22.12+。
...
真实平台协议、授权范围和可用接口尚未核实。需要服务端签名或凭证时另建服务端，不放进前端。暂不包含付费礼物、持久账号、多直播间或直播服务公网部署。
